...
class AuthControllerForAdmin {
  final GoTrueClient  _auth = Supabase.instance.client.auth;
  final SupabaseClient _supabase = Supabase.instance.client;
  Future<String> registerNewAdmin(
      String email,
      String fullname,
      String password,
    ...
    try {
      ...
      if (authResponse.user != null) {
        ...
        await _supabase.from('admin').insert({ // Thay 'profiles' bằng tên bảng của bạn nếu khác
          'admin_id': authResponse.user!.id, // Lấy user ID từ kết quả signUp
          'fullName': fullname,
          'email': email,
